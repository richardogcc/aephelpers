...
export default function Config() {
    const { showModal, setShowModal } = useInitialConfigContext();
    ...
    return (
        <div className="absolute top-0 right-0 m-4 text-black cursor-pointer hover:opacity-70 transition-all ease-in-out duration-300 hover:text-slate-900" onClick={handleChange}>
